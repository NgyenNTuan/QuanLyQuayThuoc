...
public class ThongKeThuocDuocBanNhieuNhat_GUI extends JFrame implements ActionListener,MouseListener{
	...
	private JButton btninBaoCao,btnDong;
	...
	public ThongKeThuocDuocBanNhieuNhat_GUI() {
		...
		setTitle("Giao Diện Thống Kê Số Thuốc Được Bán Nhiều Nhất Theo Ngày\r\n");
	...
	public void taoGiaoDien() {
		...
		String[] headers="STT;Mã Thuốc;Tên Thuốc;Tên Nhà Sản Xuất;Loại Thuốc;Số Lượng Bán".split(";");
		...
		scrollPane.setBounds(10, 131, 700, 482);
		...
		lblthongKeTuan = new JLabel("THỐNG KÊ TOP 10 THUỐC ĐƯỢC BÁN NHIỀU NHẤT");
		...
		btninBaoCao.setBounds(275, 25, 129, 31);
		...
		btnDong.setBounds(414, 25, 120, 31);
		panel.add(btnDong);
		...
		btnthongKe.setBounds(561, 92, 111, 31);
	...
	public void capNhatBangDuLieu() {	
		...
		try {
			...
			while (rs.next()) {
				...
				String[] rowData= {dem+"",ma,ten,tenNSX,theLoai,soLuot+""};
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(o.equals(btnthongKe)) {
			...
			tk.xuatFileExcelThuoc(ngayBD, ngayEnd);
